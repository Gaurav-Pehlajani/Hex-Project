...
import { Send, Copy as CopyIcon, Check as CheckIcon, Shield, User, LogOut, Square, Plus, ArrowDown, FileText, Clock, Download } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col relative z-10 overflow-hidden">
        ...
        <header className="h-16 flex items-center justify-between px-6 border-b border-white/5 bg-black/40 backdrop-blur-md">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button variant="ghost" size="sm" onClick={() => navigate('/academy')} className="bg-cyan-600/10 hover:bg-cyan-600/20 text-cyan-400 text-[10px] h-8 px-4 border border-cyan-500/20 rounded-full font-bold uppercase tracking-widest flex items-center gap-2 transition-all">
              🎓 Academy
            </Button>
